...
beneficio_rama_opcion1_estado1 <- prob_priori_estado1 * 0.8 * 0.7 * 250 + prob_priori_estado2 * 0.2 * 0.5 * 250 - 450000
beneficio_rama_opcion1_estado2 <- prob_priori_estado1 * 0.8 * 0.3 * 250 + prob_priori_estado2 * 0.2 * 0.5 * 250 - 450000

beneficio_rama_opcion2_estado1 <- prob_priori_estado1 * 0.7 * 0.7 * 250 + prob_priori_estado2 * 0.3 * 0.5 * 250 - 600000
beneficio_rama_opcion2_estado2 <- prob_priori_estado1 * 0.7 * 0.3 * 250 + prob_priori_estado2 * 0.3 * 0.5 * 250 - 600000
